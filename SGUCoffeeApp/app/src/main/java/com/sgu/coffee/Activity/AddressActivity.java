...
import com.sgu.coffee.Model.Address;
    ...
    private void saveAddressClick() {
        saveAddress.setOnClickListener(v -> {
            if (TextUtils.isEmpty(etFullName.getText().toString())){
                Toast.makeText(AddressActivity.this.getApplicationContext(), "Hãy nhập đầy đủ họ tên", Toast.LENGTH_SHORT).show();
                etFullName.requestFocus();
                return;
            }

            if (TextUtils.isEmpty(etPhoneNumber.getText().toString())){
                Toast.makeText(AddressActivity.this.getApplicationContext(), "Hãy nhập số điện thoại", Toast.LENGTH_SHORT).show();
                etPhoneNumber.requestFocus();
                return;
            }
            if (TextUtils.isEmpty(etAddress.getText().toString())){
                Toast.makeText(AddressActivity.this.getApplicationContext(), "Hãy nhập địa chỉ", Toast.LENGTH_SHORT).show();
