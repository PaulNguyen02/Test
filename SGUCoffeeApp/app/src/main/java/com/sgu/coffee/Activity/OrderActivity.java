...
import com.sgu.coffee.Adapter.OrderFragmentAdapter;
...
public class OrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        tabLayout.addTab(tabLayout.newTab().setText("Thanh toán tiền mặt"));
        tabLayout.addTab(tabLayout.newTab().setText("Thanh toán ZaloPay"));
