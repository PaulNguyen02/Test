...
import com.sgu.coffee.OpenAI.ChatGPTActivity;
...
public class UserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Bắt sự kiện và chuyển hướng sang trang ChatGPT
        AppCompatButton btnChatGPT = findViewById(R.id.btnChatGPT);
        btnChatGPT.setOnClickListener(v -> {
            startActivity(new Intent(UserActivity.this, ChatGPTActivity.class));
        });
    }
            ...
            btnChangePassword.setOnClickListener(v1 -> {
                ...
                if(password.equals(user.getPassword())){
                    if(newPassword.equals(reNewPassword)){
                        ...
                        tvErrorChangePassword.setText("Mật khẩu nhập lại không trùng khớp!");
                    }
                } else {
                    tvErrorChangePassword.setText("Mật khẩu của bạn không đúng");
                }
            });
        });
    }
