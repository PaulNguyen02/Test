...
public class ForgotPasswordActivity extends AppCompatActivity {
    ...
    private void btnSubmitClick() {
        btnSubmit.setOnClickListener(view -> {
            ...
            progressDialog.setMessage("Đang kiểm tra..."); // Setting Message
            progressDialog.setTitle("Quên mật khẩu"); // Setting Title
...
//                                                        startActivity(new Intent(ForgotPasswordActivity.this, LoginActivity.class));
                                            ...
                                            Toast.makeText(ForgotPasswordActivity.this, "Mật khẩu nhập lại không trùng với ban đầu!", Toast.LENGTH_SHORT).show();
                                        }
                                    });
                        ...
                        Toast.makeText(ForgotPasswordActivity.this, "Tên đăng nhập không tồn tại!", Toast.LENGTH_SHORT).show();
                    }
                }
