...
import com.sgu.coffee.Adapter.CheckOutAdapter;
...
import com.sgu.coffee.Zalo.Api.CreateOrder;
...
//                ZaloPaySDK.init(2553, Environment.SANDBOX);
                ...
                Toast.makeText(getApplicationContext(), "Hãy chọn phương thức thanh toán", Toast.LENGTH_LONG).show();
            }
        });
    ...
    private void newOrder(String method) {
        ...
        if (address == null) {
            Toast.makeText(CheckOutActivity.this.getApplicationContext(), "Làm ơn thêm địa chỉ trước khi thanh toán", Toast.LENGTH_SHORT).show();
        } else {
